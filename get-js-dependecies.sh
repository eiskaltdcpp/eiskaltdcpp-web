...
wget -nv -c https://code.jquery.com/jquery-1.12.4.js                                                 -O jquery.js
...
wget -nv -c https://raw.github.com/Mottie/tablesorter/v2.29.0/dist/js/jquery.tablesorter.js          -O jquery.tablesorter.js
wget -nv -c http://requirejs.org/docs/release/2.3.5/comments/require.js                              -O require.js
